# CLAUDE.md — TradeMark BrandCare

> Copiar este archivo a la raíz de cada proyecto cliente.
> El @import trae todas las skills, convenciones y flujo de trabajo desde claude pro.

---

@/Users/mateocarballido/Desktop/claude pro/CLAUDE.md
...
> Las skills están en `/Users/mateocarballido/Desktop/claude pro/.agents/skills/`
...
- Antes de build o presentación al cliente →
  leer `…/codex/SKILL.md` y ejecutar codex siguiendo esas instrucciones
...
## SEO (cuando la página esté lista para optimizar)

> Path base: `/Users/mateocarballido/Desktop/claude pro/.agents/skills/claude-seo/`

- Estructura semántica y headings → leer `seo-headings.md`
- Meta tags y título → leer `seo-meta.md`
- Schema markup (LocalBusiness) → leer `seo-schema.md`
- Imágenes y alt texts → leer `seo-images.md`
- Velocidad y performance → leer `seo-speed.md`
- Auditoría general → leer `seo-report.md`
- Keywords y contenido → leer `seo-keywords.md`
